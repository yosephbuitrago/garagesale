...
import (
	...
	"github.com/yosephbuitrago/garagesale/business/tests"
)
...
func TestAuthenticate(t *testing.T) {
	...
	t.Log("Given the need to authenticate users")
	{
		...
		t.Logf("\tTest %d:\tWhen handling a single User.", testID)
		{
			...
			nu := user.NewUser{
				Name:            "Yoseph Buitrago",
				Email:           "yosephbuitrago@gmail.com",
				Roles:           []string{auth.RoleAdmin},
				Password:        "goroutines",
			...
			claims, err := u.Authenticate(ctx, traceID, now, "yosephbuitrago@gmail.com", "goroutines")
			if err != nil {
